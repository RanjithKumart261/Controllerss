...
using Solution.BusinessEntities;
...
namespace Solution.Controller
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        {
            repository = new UserRepository("User Id=postgres;Password=TRIVENI@1;Host=localhost;Database=Solution");
        ...
        public ActionResult<IEnumerable<User>> Get()
        {
            ...
            return Ok(result.Select(x => new UserBe
            {
                Email = x.Email,
